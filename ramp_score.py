...
# forecast reference list, forecast model list, minutes to average on, names, plot.
def get_ramp_score(ref_ls, model_ls, avg_mins=60, sens = 80, name='Compete', plot=True):
    kwh_sens = sens
